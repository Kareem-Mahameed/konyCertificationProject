function initializetmpSegRowOnSale() {
    flxSegRowOnSale = new kony.ui.FlexContainer({
    ...
    flxSegRowOnSale.setDefaultUnit(kony.flex.DP);
    ...
    flxSegRowOnSale.add(imgRowThumb, flxRowText);
}